...
jobs:
  build_and_test:
    ...
    steps:
      ...
      - uses: step-security/actions-rs-toolchain@v1
        with:
          toolchain: stable
      - uses: step-security/actions-rs-cargo@v1
        with:
          command: build
...
You can use [`step-security/actions-rs-toolchain`](https://github.com/step-security/actions-rs-toolchain)
